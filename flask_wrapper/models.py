...
class User(UserMixin, db.Model):
    ...
    setup_low = db.Column(db.Float)
    setup_high = db.Column(db.Float)
    top_low = db.Column(db.Float)
    top_high = db.Column(db.Float)
    impact_low = db.Column(db.Float)
    impact_high = db.Column(db.Float)
